...
static Key keys[] = {
    ...
    { MODKEY|ShiftMask,             XK_m,      spawn,           SHCMD("~/.local/bin/dman")},
    { MODKEY|ShiftMask,             XK_a,      spawn,           SHCMD("~/.local/bin/dklay.sh")},
    { MODKEY|ShiftMask,             XK_x,      spawn,           SHCMD("~/.local/bin/dpower.sh")},
    { MODKEY|ShiftMask,             XK_d,      spawn,           SHCMD("~/.local/bin/ddown.sh")},
    { MODKEY|ShiftMask,             XK_v,      spawn,           SHCMD("~/.local/bin/dvid.sh")},
    { MODKEY,                       XK_o,      spawn,           SHCMD("~/.local/bin/dopen.sh")},
